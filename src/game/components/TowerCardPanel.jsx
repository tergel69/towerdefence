 ...
 * Displays a tower as a clickable card with cost, icon, and basic info
 */
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <span style={{ fontSize: 14, fontWeight: 700, color: canReroll ? '#fbbf24' : 'rgba(255,255,255,0.3)' }}>
          {cost}
        </span>
      </div>
    </button>
...
export default function TowerCardPanel({ 
  ...
  const availableTowers = useMemo(() => {
    ...
    const unlocked = unlockedTowerIds !== null && unlockedTowerIds !== undefined && unlockedTowerIds.length > 0
      ? unlockedTowerIds
